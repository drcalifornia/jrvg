...
if ($idioma_ativo == 'pt') {
    ...
    $breve_historia_p3 = '<br><span class="thanks">Agradecimento</span><br><br>Quero expressar meu mais sincero agradecimento a Carlos, Fergus e Verônica pelo valioso apoio e dedicação na criação do meu site. Graças ao esforço, criatividade e comprometimento de vocês, hoje tenho uma ferramenta que reflete de forma clara e profissional o meu trabalho, minhas ideias e meus sonhos.<br>A paciência de vocês, suas contribuições e o tempo investido neste projeto tornaram possível que esta página não seja apenas um espaço digital, mas também um reflexo de quem eu sou e do que desejo compartilhar com os outros.<br>Com todo carinho e gratidão,<br><br><span class="sign">Ricardo Velez</span>';
